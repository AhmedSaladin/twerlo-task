...
export default class Database {
  ...
  getWords() {
    const wordList = new Promise<Word[]>((resolve, reject) => {
      resolve([
  ...
  getRank(score: number) {
    const rank = new Promise<number>((resolve, reject) => {
      const list = [
        20, 90, 100, 50, 10, 50, 60, 0, 60, 10, 90, 30, 100, 30, 20, 90, 40, 20, 10, 60, 50, 100,
        50, 80, 50, 80, 60, 80, 10, 40
      ]

      const filteredList = list.filter(element => score > element);
      const rank = (filteredList.length / list.length) * 100;
